...
\setlength\fboxrule{0pt}
	\fbox{
		\begin{minipage}{8em}
			\includegraphics[width=4.5em,height=4.5em]{figs/cpl_logo.png}
			\includegraphics[width=5em,height=4em]{figs/mps_logo.png}
		\end{minipage}
	}
}
% TITLE & AUTHORS
...
\setlength\fboxrule{0pt}
	\fbox{
		\begin{minipage}{8em}
			\includegraphics[width=4em,height=5em]{figs/cnl.png}
			\includegraphics[width=4em,height=5em]{figs/unisa_logo.png}
		\end{minipage}
	}
}
