...
The resulting quantity (*Q weight*) thus affords an indication of the relative quality of the resolved peak in terms of how well its distributional characteristics conform to the ideal of a highly powered, less variable (i.e. narrower) peak (as opposed to broader and/or shallower counterparts).
Within-subject channel estimates are scaled in proportion to the peak with the highest *Q weight*, and the (weighted) cross-channel average computed (hence, channels with the strongest evidence of PAF detection contribute more information to the mean estimate of the PAF).
