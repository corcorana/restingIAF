...
This is perhaps unsurprising, since identifying the bounds of the alpha component is more challenging (and thus, more susceptible to errors that bias CoG estimation) under noisy signal conditions.
