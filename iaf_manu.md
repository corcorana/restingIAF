...
The classical method of estimating IAF relies on delineating the peak alpha frequency (PAF); a singular, prominent peak within that portion of the power spectral density (PSD) plot assumed to constitute the domain of the alpha-band frequency range ([Fig_pafs](#pafs)).
