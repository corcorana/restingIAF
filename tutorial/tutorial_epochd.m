...
dataPath = '~/Dropbox/Script IAF - Lucas/';

% define required parameters
n = 4;              % number of subjects for analysis
...
for ix = 1:n     % for each i-th subject
    ...
    for jx = 1:2       % for each j-th resting-state recording per subject
        
        % setup filename / path
        fileName = sprintf(['dtmof_%02d_', num2str(jx), '.set'], ix);
